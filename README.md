...
```
site:"tld" intext:"Warning: mysqli_fetch_array() expects parameter * to be mysqli_result, bool given in * on line *"
site:"tld" intext:"Warning: mysql_query(): supplied argument is not a valid MySQL-Link resource"
inurl:"view_items.php?catid=*"
inurl:"article.php?id=*"
inurl:"book.php?id=*"
inurl:"shopping-cart.php?id=*"
inurl:"product.php?id=*"
inurl:"view.php?id=*"
inurl:"articles.php?id=*"
inurl:"inner-articles.php?id=*"
```
